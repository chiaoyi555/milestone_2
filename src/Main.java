public class Main {
    ...
    public static void main(String[] args) {
        ...
        String testI_Format = "  add   $a1,   $t8,  $t9 #comment"; // s.nextLine(); // input scanner
        String line = " lw  $a3,  -82($t8) #random comment";
        ...
        String registers = line.substring(splitInstruction); // registers substring
            ...
            registers = registers.replace("(", ",");
        String [] regArray; // Arrays for registers (for I-Format: [$reg1][number][$reg2])
        String splitAtComma = ",";
        ...
        if (Instructions.determineInstructionType(instruction).equals("R_Format")) {
            ...
            inst = Instructions.iFormatEncoding();
        ...
        } else if (Instructions.determineInstructionType(instruction).equals("syscall")) {
